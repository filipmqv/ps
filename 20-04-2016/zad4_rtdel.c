/*
 * DODAJE WPIS DO TABLICY ROUTINGU
 * 
 *
 * Compilation:  gcc -Wall ./zad4_rtdel.c -o ./zad4_rtdel
 * Usage:        ./zad4_rtdel NETIP(nazwa sieci docelowej) MASK(w postaci numerycznej np 2, 4 8 itp) GWIP(brama - komputer w sieci ip do ktorej jestesmy podlaczeni)netlink flags remove route
